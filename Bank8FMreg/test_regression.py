...
plt.xlabel("threads")
plt.ylabel("speedup")
plt.title("Speedup of parallel program with different input sizes")
plt.xlim((0, 257))
plt.ylim((0,80))
plt.plot(x, y[0], '*-', label="25% of data")
plt.plot(x, y[1], 'v-', label="50% of data")
plt.plot(x, y[2], '^-', label="100% of data")
plt.legend()
plt.show()
plt.hold(False)